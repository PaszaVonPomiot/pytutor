...
class CallableCheckExample:
    pass

callable(CallableCheckExample)  # is class callable
callable(CallableCheckExample())  # is instance callable

class CallableObjectExample:
    def __call__(self):
        print("Im a function")

callable(CallableObjectExample)  # is class callable
callable(CallableObjectExample())  # is instance callable
